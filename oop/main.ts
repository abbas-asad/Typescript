...
class Book {
  ...
  aname: string;
  price: number;
  constructor(bname: string, aname: string, price: number) {
...
class House {
  Ownername: string;
  Housenumber!: number; // If you don't want to use this property so you can, because of Exclamation mark
  readonly OwnerCNIC: number; // uneditable
  constructor(name: string, /* hNum: number ,*/ OwnerNIC: number) {
    this.Ownername = name;
